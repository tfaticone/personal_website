...
{
    $person_info = file_get_contents('http://www.se.rit.edu/~tjf4881/swen344/REST/RESTAPI.php?action=get_person&id=' . $_GET["id"]);
...
else // else take the person list
{
    ...
    $person_list = file_get_contents('http://www.se.rit.edu/~tjf4881/swen344/REST/RESTAPI.php?action=get_person_list');
    ...
    <ul>
        <?php foreach ($person_list as $person): ?>
            <li>
                ...
                <a href=<?php echo "http://www.se.rit.edu/~tjf4881/swen344/REST/RestClient.php?action=get_person&id=" . $person["id"]  ?> alt=<?php echo "person_" . $person_["id"] ?>><?php echo $person["name"] ?></a>
            </li>
        <?php endforeach; ?>
    </ul>
    <?php
